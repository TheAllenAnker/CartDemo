...
<!-- goods区域 -->
<form action="/cart/check.do" id="cartBody">
        ...
        <div class="bd">
            ...
            <c:forEach items="${carts}" var="cart">
                <ul class="order-list">
                    ...
                    <li class="number">
                        <div class="input-num">
                            <a href="/cart/decrement.do?productId=${cart.productId}">-</a>
                            <input type="text" value="${cart.count}" class="num">
                            <a href="/cart/increment.do?productId=${cart.productId}">+</a>
                        </div>
                    </li>
    ...
    <div class="pay-bar">
        ...
        <%--<span>应付金额：</span>--%>
        <%--</div>--%>
        <button onclick="document.getElementById('cartBody').submit()">去结算</button>
    </div>
</form>
<!-- footer区域 -->
<footer class="footer">
